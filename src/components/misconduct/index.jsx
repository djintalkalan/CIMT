...
class Misconduct extends Component {
    ...
    componentWillMount() {
        ...
        let onEdit = (data) => {
            this.setState({
                ...
                misconduct_desc: data.misconduct_desc,
                id: data.id
            })
        }
        this.columnDefs = [
            { headerName: "ID", field: "id", sortable: true, filter: true, width: 120 },
            { headerName: "Misconduct Type", field: "misconduct_type", sortable: true, filter: true, width: 170 },
            { headerName: "Misconduct Desc", field: "misconduct_desc", sortable: true, filter: true, width: 170 },
            {
                headerName: "Action", field: "misconduct_type", sortable: false, filter: false, cellRendererFramework: function (params) {
    ...
    handleSubmit = (event) => {
        ...
        const { misconduct_type, misconduct_desc } = this.state
        ...
        const params = {
            misconduct_type: this.state.misconduct_type,
            misconduct_desc: this.state.misconduct_desc,
                ...
                <Modal.Body>
                    <form
                        ...
                        <div className="form-group">
                            ...
                            <input
                                value={this.state.misconduct_type}
                                onChange={this.handleChange}
                                type="text" className="form-control" id="misconduct_type" name="misconduct_type" placeholder="Type" />
                        </div>
                        <div className="form-group">
                            <span>Misconduct Description</span>
                            <input
                                value={this.state.misconduct_desc}
                                onChange={this.handleChange}
                                type="text" className="form-control" id="misconduct_desc" name="misconduct_desc" placeholder="Description" />
                        </div>
                    ...
                    <div className="container-fluid">
                        <div className="row">
                            ...
                            <div className="col-md-12 mb10">
                                <button onClick={() => this.setState({ isAddVisible: true, id: "", misconduct_type: "", misconduct_desc: "" })} className="btn btn-sm btn-success">Add</button>
                            </div>
                        </div>
                        <div className="row">
